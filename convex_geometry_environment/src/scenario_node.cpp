 ...
 * @brief Convex geometry environment node entrypoint
 */
...
int main(int argc, char** argv) {
    ros::init(argc, argv, "convex_geometry_environment_node");
    ros::NodeHandle nh("~");

    ROS_INFO("=================================================");
    ROS_INFO("  Convex Geometry Environment Generator Node");
    ROS_INFO("  凸几何环境生成器节点");
    ROS_INFO("=================================================");

    convex_geometry_environment::ScenarioManager scenario_mgr(nh);
