...
void
optimizeMap(mocka::Maps::BasicInfo& in, const std::string& frame_id)
{
  ...
  in.output->header.frame_id = frame_id;
...
main(int argc, char** argv)
{
  ...
  nh_private.param("frame_id", frame_id, std::string("world"));
