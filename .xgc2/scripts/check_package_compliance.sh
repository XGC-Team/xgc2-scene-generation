...
grep -Fq '${msgs_pkg} (>= 1.1.4-10)' .xgc2/scripts/package_debs.sh
grep -Fq '${env_pkg} (>= 1.1.4-10)' .xgc2/scripts/package_debs.sh
grep -Fq '${mockamap_pkg} (>= 1.1.4-10)' .xgc2/scripts/package_debs.sh
