...
build_ros_package_deb \
  ...
  "libxgc2-math-dev (>= 0.5.6-6~focal), ${msgs_pkg} (>= 1.1.4-11), ros-noetic-roscpp, ros-noetic-rospy, ros-noetic-geometry-msgs, ros-noetic-std-msgs, ros-noetic-visualization-msgs, ros-noetic-tf2, ros-noetic-tf2-geometry-msgs, ros-noetic-tf2-ros, python3-yaml" \
...
write_control \
  "${meta_root}" \
  "${meta_pkg}" \
  "${msgs_pkg} (>= 1.1.4-11), ${env_pkg} (>= 1.1.4-11), ${mockamap_pkg} (>= 1.1.4-11)" \
